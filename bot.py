...
async def connect_to_voice(ctx):
    ...
    async with lock:
        ...
        if player:
            ...
            print(
                f"ℹ️ Existing voice client: "
                f"{type(player).__name__}"
            )
            ...
            try:
                ...
                print("⚠️ Existing player is invalid.")
                traceback.print_exc()
